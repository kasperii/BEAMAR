...
namespace GoogleARCore.Examples.CloudAnchors
{
    ...
    public class CloudARController : MonoBehaviour
    {
        ...
        private bool noPlaneDetected = true;
        ...
        public void Update()
        {
            ...
            if(noPlaneDetected)
            {
                ...
                for (int i = 0; i < m_AllPlanes.Count; i++)
                {
                    ...
                    {
                        noPlaneDetected = false;
                        UIController.SearchToStartView();
                        _ResetStatus();
                        break;
                    }
                }
            ...
            if (m_LastPlacedAnchor != null)
            {
                ...
                var anchorObject = Instantiate(CloudAnchorPrefab, m_LastPlacedAnchor.transform.position,
        ...
        private void _HostLastPlacedAnchor()
        {
            ...
            XPSession.CreateCloudAnchor(anchor).ThenAction(result =>
            {
                ...
                // Give anchor reference to game manager & connecting to Photon
        ...
        private void _ResolveAnchorFromId(string cloudAnchorId)
        {
            XPSession.ResolveCloudAnchor(cloudAnchorId).ThenAction((System.Action<CloudAnchorResult>)(result =>
            {
                ...
                // Give anchor reference to game manager & connecting to Photon
                gameManager.setAnchor(m_LastResolvedAnchor);
                photonController.Connect();
            }));
        }
