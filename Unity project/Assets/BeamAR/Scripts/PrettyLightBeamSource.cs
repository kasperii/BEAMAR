...
public class PrettyLightBeamSource: MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.localScale = new Vector3(0.1f, 0.01f, distanceVectors);
    ...
    public void InstantiateLightSource(int uIn, Vector3[] LineIndexIn)
    {
